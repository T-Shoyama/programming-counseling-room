...
try{
  ...
  if(!isset($_SESSION['User'])) {
    ...
    $com_count_all = $user->com_count_mine($_SESSION['User']['id']);
    ...
    <div id="wrapper">
      <div id="profile">
        ...
        <div class="user_status">
          <p class="user_name"><?php if(isset($_SESSION['User']['user_name'])){ echo $_SESSION['User']['user_name'];}else echo $result['User']['user_name'];?>さんのマイページ</p>
          <p class="time">あなたの記事へのコメント総数：<?php print($com_count_all) ?>件</p>
        </div>
      </div>
        ...
        <div id="content_wrapper">
            ...
            <ul class="title_all">
              ...
              <?php foreach($myTroFindAll as $myTroFind) { ?>
                ...
                <p class="time">コメント数：<?php print($myTroFind['count(c.id)']) ?>件</p>
        ...
        <div id="content_wrapper">
            ...
            <ul class="title_all">
              ...
              <?php foreach($keep as $row) { ?>
                ...
                <p class="time">コメント数：<?php print($row['count(c.id)']) ?>件</p>
